...
def upgrade() -> None:
    """Upgrade schema."""
    op.add_column('configuration_rule', sa.Column('alternative_catalog_ref', sa.String(), nullable=True))
    op.add_column('configuration_rule', sa.Column('outdoor_alternative_catalog_ref', sa.String(), nullable=True))
