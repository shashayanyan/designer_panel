crn_lines = [
    ...
    "The enclosure shall support high static loads on the mounting plate to allow installation of soft starters and variable speed drives for pumping applications.",
    "The enclosure shall be manufactured from steel with epoxy‑polyester coating suitable for humid indoor water and wastewater environments.",
    "The enclosure shall use a foamed‑in gasket to ensure long‑term sealing performance in high‑humidity pumping environments.",
    "The enclosure shall be designed for safe bottom cable entry of pump motor feeders, including sealing systems suitable for wet floors.",
    "The enclosure range shall provide multiple depth options for the same footprint to manage heat dissipation and cabling of DOL, soft starter, and VSD pump systems.",
    "The enclosure door shall allow reversible opening with up to 180° opening angle to facilitate maintenance in confined pump rooms.",
