...
ats01_motor_feeders = [
    ...
    "The starter shall provide adjustable acceleration and deceleration ramp times, configurable from 1 to 10 seconds.",
    "The starter shall provide adjustable starting torque from 30% to 80% of the motor direct-on-line starting torque.",
    "The starter shall include discrete logic inputs for stop, run, and boost-on-start functions, including a BOOST function for difficult starting conditions.",
    "The starter shall provide local status indication for starter power and nominal voltage reached, and shall provide an end-of-start signal for external control or monitoring.",
    "The starter shall be compact and suitable for DIN-rail or panel mounting, with side-by-side installation capability where permitted by the manufacturer.",
]
