ats130_motor_feeders = [
    ...
    "The soft starter shall include an internal bypass function to reduce heat dissipation and operating losses after completion of the starting ramp.",
    "The soft starter shall include deceleration voltage ramp and boost functions to support controlled stopping and difficult starting conditions.",
    "The soft starter shall include built-in protection monitoring for mains phase failure, starter thermal condition, bypass error, and control-voltage availability.",
    "The soft starter shall use 24 V DC control supply and shall provide PLC-compatible digital inputs, including run/stop control and boost-on-start command.",
    "The soft starter shall provide relay and digital output signalling for external control, status, and fault indication.",
    "The soft starter shall use maintenance-reducing power and control terminations, including Everlink-type power terminals and spring control terminals, eliminating the requirement for annual terminal retightening where installed according to manufacturer instructions.",
    "The soft starter shall support compact panel integration by DIN-rail or backplate mounting, side-by-side installation where permitted, and direct mechanical coordination with the associated TeSys Deca motor protection device.",
]
...
ats130_control_philosophy = [
    ...
    "Failure handling: if any pump/soft starter becomes unavailable or reports a starter, phase, bypass, thermal, or control-voltage fault, remaining pumps shall continue to operate within available capacity and generate an alarm.",
]
