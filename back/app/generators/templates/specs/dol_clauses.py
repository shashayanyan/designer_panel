...
dol_motor_feeders = [
    ...
    "Each DOL starter shall include a TeSys Deca type line contactor rated for AC-3 motor switching duty and selected according to the motor full-load current and utilisation category.",
    "Each starter shall include short-circuit protection, isolation, and motor overload protection using a coordinated motor circuit breaker and/or overload relay arrangement suitable for the selected motor rating.",
    ...
    "The starter shall provide run, fault, trip, ready, and local/remote interface signals through auxiliary contacts and overload or circuit-breaker trip indication where required by the selected control architecture.",
]
