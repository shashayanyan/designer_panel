...
dol_motor_feeders = [
    ...
    "The starter assembly shall comprise, as a minimum, one 3-pole switching device and one short-circuit protective device, with overload protection provided either by a thermal overload relay or by a thermal-magnetic motor circuit breaker.",
    "The starter shall provide non-reversing direct-on-line starting and stopping of one three-phase squirrel-cage induction motor in utilization category AC-3 at 50/60 Hz.",
    "The starter shall be designed so that restoration of motor operation after an overload or undervoltage trip requires a deliberate reset or deliberate restart action.",
]
