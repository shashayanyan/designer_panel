...
class DigitalTwinRequest(BaseModel):
    ...
    single_line_diagram_b64: Optional[str] = Field(None, description="Base64 encoded string of the single line diagram image generated by frontend")
...
class DigitalTwinResponse(BaseModel):
    ...
    single_line_diagram_b64: Optional[str] = None
