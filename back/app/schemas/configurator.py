...
class DigitalTwinRequest(BaseModel):
    ...
    environment: Optional[str] = Field("Indoor", description="Installation environment (Indoor, Outdoor, Not sure)")
    enclosure_ref: Optional[str] = Field(None, description="Reference for the selected enclosure option, if any")
