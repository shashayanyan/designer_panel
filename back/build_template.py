...
doc.add_paragraph(
    "This document outlines the standard engineering parameters for a {{ load_count }}-pump Water Booster set, rated at {{ motor_power_kw }} kW per motor."
)

# Add Control Section
doc.add_heading("2. Control Panel & Enclosure", level=1)
doc.add_paragraph(
    "The control panel shall be housed in an enclosure dimensioned at {{ enclosure_dims }} with a mounting type of {{ enclosure_mounting }}. Default cabinet rating is IP54."
)
